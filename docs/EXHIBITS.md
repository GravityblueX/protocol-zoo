...
| 展品 | 权威规范 | 实验状态 | 核心问题 |
|---|---|---|---|
| Telnet | RFC 854, RFC 855 | 隔离 TCP fixture + anatomy | IAC 协商如何嵌入字节流 |
| FTP | RFC 959, RFC 2428 | control/data 拓扑 fixture | 为什么 active/passive 与 NAT 强相关 |
...
| SCTP | RFC 9260 | capability/fixture | 多流、多宿主 |
| DCCP | RFC 4340 | static fixture | 拥塞控制而不保证可靠 |
| UDP-Lite | RFC 3828 | static fixture | 部分 checksum coverage |
| GRE | RFC 2784, RFC 2890 | static fixture | 隧道封装 |
| IP-in-IP | RFC 2003 | static fixture | 直接 IP 封装 |
